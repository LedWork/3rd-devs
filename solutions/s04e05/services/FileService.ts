...
export class FileService {
  ...
  constructor(storageDir?: string) {
    this.STORAGE_DIR = storageDir || path.join(process.cwd(), 'web', 'storage');
    this.TEMP_DIR = path.join(this.STORAGE_DIR, 'temp');
   ...
   * @returns The Markdown content as a string.
   */
  async readPdfFile(filePath: string): Promise<string> {
