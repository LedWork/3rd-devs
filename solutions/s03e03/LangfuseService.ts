...
export class LangfuseService {
  ...
  async finalizeSpanString(span: LangfuseSpanClient, name: string, input: string[], output: string): Promise<void> {
    span.update({
      name,
      output,
    });
  ...
  async finalizeTraceString(trace: LangfuseTraceClient, input: string[], output: string): Promise<void> {
    await trace.update({ 
